// fs.ts — Shared file system service for Effect-based DI
//
// Union of methods from emacs-bridge and gravity-server.
// Wraps synchronous Node.js file I/O in Effect for testability
